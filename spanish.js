...
// Establece el atributo 'max' del input a la longitud de la matriz de párrafos
...
generateBtn.addEventListener('click', function (e) {
    ...
    if (value < 0) {
        alert('Introduce un dato vacío para generar aleatoriamente o el número de párrafos que quieres.');
