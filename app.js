...
generateBtn.addEventListener('click', function (e) {
    ...
    if (value < 0 && window.location == 'https://javiervaleriano.github.io/javier-fun-lipsum-generator/index.html') {
        alert('Enter an empty data to randomly generate or the number of paragraphs you want.');
    } else if (value < 0 && window.location == 'https://javiervaleriano.github.io/javier-fun-lipsum-generator/spanish.html') {
